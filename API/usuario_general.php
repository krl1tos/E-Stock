...
/**
    ...
    function usuarioExiste(Usuario $usuario) {
        ...
        if ($bdd->estado == "OK") {
            ...
            $consulta="select count(*) as conteo from usuario where nombre = ? and user_email = ?";
            ...
            $sentencia->bind_param("ss",$usuario->nombre, $usuario->email);
